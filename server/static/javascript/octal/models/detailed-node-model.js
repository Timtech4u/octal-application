/*global define*/
define(["underscore", "lib/kmapjs/models/node-model", "octal/collections/node-property-collections", "octal/collections/detailed-edge-collection"], function(_, Node, NodePropertyCollections, DetailedEdgeCollection){
  ...
  var DetailedNode = Node.extend({
    ...
    initialize: function() {
      ...
      thisModel.isLearnedOrImplicitLearned = function(){
        return nodePvt.implicitLearn || window.oGlobals.auxModel.conceptIsLearned(thisModel.id);
      };

      thisModel.isLearned = function(){
        return window.oGlobals.auxModel.conceptIsLearned(thisModel.id);
      };
