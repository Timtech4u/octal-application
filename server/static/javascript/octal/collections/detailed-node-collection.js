/*global define*/
define(['lib/kmapjs/collections/node-collection', 'octal/models/detailed-node-model', 'underscore'], function(NodeCollection, DetailedNodeModel, _){
  return NodeCollection.extend({
    ...
    parse: function(response){
      ...
      if (window.oGlobals && window.oGlobals.auxModel && response.hasOwnProperty("titles")){
        window.oGlobals.auxModel.set("titles", response.titles);
      }
    ...
    getTimeEstimate: function(){
      var aux = window.oGlobals.auxModel,
          total = 0;
